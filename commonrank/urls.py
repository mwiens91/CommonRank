...
urlpatterns = [
    ...
    path(r'leaderboard/<int:leaderboard_id>/member/<int:member_id>/match/create', core_views.create_match, name='match_create'),
    ...
    path(r'leaderboard/<int:leaderboard_id>/member/<int:member_id>/match_history', core_views.match_history, name='match_history'),
    path(r'leaderboard/<int:leaderboard_id>/member/<int:member_id>/rankings', core_views.leaderboard_rankings, name='leaderboard_rankings'),
